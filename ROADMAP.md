...
- The Draft Change Graph as the whole model: Resources and Relations, ChangePacks and sealed RevisionPacks, Evidence, Assessments, Representations, Gates and immutable Decisions.
...
### Future cross-project Pack transfer

<!-- retired-architecture-ok: the single forward-looking roadmap note; nothing here ships in v0.3.4. -->
**Future cross-project Pack transfer.** A future release may define a portable representation for moving ChangePack/RevisionPack work between Draft projects. The format, identity, trust model, provenance model, signing, archive layout, adoption semantics and lifecycle are intentionally **not** specified by v0.3.4, and nothing in this release reserves a name, an identifier prefix, a file extension or a storage path for them.
