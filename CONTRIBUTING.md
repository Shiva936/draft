...
Draft is a local-first change-control tool. Contributions should preserve the v0.3.0 boundary: Draft owns `.draft/`, verifies and saves changepacks locally, and treats `target.local` as an opaque command string.
