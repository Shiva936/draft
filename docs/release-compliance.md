...
| Protected data and redaction | Implemented | Central path guards keep `.draft/` and protected content out of candidates, exports, logs, ChangePack-workspace writes, and execution output; durable payload redaction has focused tests. |
