...
Draft v0.3.2 supports generic command hooks under `hooks.*`.
...
```bash
draft save auth-refactor --var ticket="AUTH-123" release="v0.3.2"
```
...
That behavior is only user-scripted hook execution. Draft v0.3.2 has no native push, forge, PR, hosted review, marketplace, cloud sync, or GitHub feature.
