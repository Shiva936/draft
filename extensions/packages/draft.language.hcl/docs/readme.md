...
Draft itself knows nothing about HCL: it manages resources, changes,
evidence and approvals. This package supplies the interpretation — which
resources are HCL sources, how to check them, and how to present
them — and Draft applies it without ever learning the language.

## What it contributes

- **`draft.language.hcl/source`** — the class assigned to resources this package recognizes. A
