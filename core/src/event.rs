...
impl EventKind {
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            EventKind::PackSubmitted => "PackSubmitted",
            ...
            EventKind::SubmitStarted => "SubmitStarted",
            EventKind::SubmitHookStarted => "SubmitHookStarted",
            EventKind::SubmitHookCompleted => "SubmitHookCompleted",
            EventKind::SubmitHookFailed => "SubmitHookFailed",
            ...
            EventKind::SubmitFinalized => "SubmitFinalized",
...
mod tests {
    ...
    fn tampering_is_detected() {
        ...
        l.append(sample(EventKind::PackSubmitted, "pck_a")).unwrap();
