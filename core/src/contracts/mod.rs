...
contract_registry! {
    ...
    DraftGlobalHome => ("draft-global-home", Persisted, Some("draft-global-home.schema.json"), VersionPolicy::V1_ONLY),
    AdoptionReceipt => ("adoption-receipt", Persisted, None, VersionPolicy::V1_ONLY),
    ChangePackGraphIndex => ("change-pack-graph-index", Persisted, None, VersionPolicy::V1_ONLY),
    ...
    ChangePackManifest => ("change-pack", PersistedAndWire, Some("change-pack.schema.json"), VersionPolicy::V1_ONLY),
    ChangePackContentRevisionRecord => ("change-pack-content-revision", PersistedAndWire, Some("change-pack-content-revision.schema.json"), VersionPolicy::V1_ONLY),
    ChangePackLock => ("change-pack-lock", PersistedAndWire, Some("change-pack-lock.schema.json"), VersionPolicy::V1_ONLY),
    ChangePackWorkspace => ("change-pack-workspace", Persisted, None, VersionPolicy::V1_ONLY),
    ChangeSet => ("change-set", PersistedAndWire, None, VersionPolicy::V1_ONLY),
    RevisionPackRepresentationBundle => ("revision-pack-representation-bundle", PersistedAndWire, None, VersionPolicy::V1_ONLY),
    ...
    RevisionPackEvidence => ("revision-pack-evidence", Persisted, None, VersionPolicy::V1_ONLY),
    ReviewProgressState => ("review-progress-state", PersistedAndWire, Some("review-progress-state.schema.json"), VersionPolicy::V1_ONLY),
