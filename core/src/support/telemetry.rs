...
pub enum Counter {
    ...
    ChangePackDefinitionCasConflicts,
    ...
    PromotionChangePackCompletionRecoveries,
...
pub const ALL: &[Counter] = &[
    ...
    Counter::ChangePackDefinitionCasConflicts,
    ...
    Counter::PromotionChangePackCompletionRecoveries,
...
const NAMES: [&str; ALL.len()] = [
    ...
    "change_pack_definition_cas_conflicts",
    ...
    "promotion_change_pack_completion_recoveries",
